...
import { Instagram, ChevronLeft, Video, ImageIcon, BarChart2 } from "lucide-react";
      ...
      <main className="ml-56 flex-1 p-8 max-w-4xl">
        ...
        <div className="mb-8">
          <p className="text-xs text-green-600 font-mono tracking-widest uppercase mb-1">
            <span className="text-red-500">&gt;</span> instagram.exe
          </p>
          <h1 className="text-3xl font-black font-mono text-green-300">Instagram</h1>
          <p className="text-green-700 text-sm font-mono mt-1">@djthirstyboy · Reels, stories, feed</p>
        </div>

        <div className="holo-card rounded-xl border border-pink-500/20 bg-black/40">
          <div className="p-12 flex flex-col items-center justify-center text-center">
            <div className="relative w-16 h-16 mb-6">
              <span className="ping-slow absolute inset-0 rounded-full bg-pink-500/20" />
              <div className="relative w-16 h-16 rounded-full bg-pink-500/5 border border-pink-500/30 flex items-center justify-center">
                <Instagram className="w-7 h-7 text-pink-500/60" />
              </div>
            </div>
            ...
            <p className="text-sm text-green-700 font-mono max-w-sm mb-6">
              Auto-post reels, stories, and feed content with AI-generated captions and hashtags.
            </p>
